...
import metaheuristics.ga.AbstractMGA;
 ...
 */
public class MGA_QBF extends AbstractMGA<Integer, Integer> {
	 ...
	 */
	public MGA_QBF(Integer popSize, Double mutationRate, String filename) throws IOException {
		super(new QBF(filename), popSize, mutationRate);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		MGA_QBF ga = new MGA_QBF(100, 1.0 / 100.0, "instances/qbf060");
